...
| R0-01 | **MERGED** |
| R0-02 | **IN_PROGRESS**（WP-05a / PR #31、WP-05b / PR #32、WP-05c / PR #33、WP-05d / PR #34、WP-05e / PR #35、WP-05f / PR #36 均已 MERGED；WP-05g / T-05-07 已 DISPATCHED，等待 CC PR） |
...
| 轮到谁 | **CC**（turn 0234：实现 WP-05g / T-05-07，并开 PR 回报） |
| 第一治理提交 | `bf21348` |
...
| 0234 | CODEX → CC | WORK_ORDER | WP-05g | 启动 WP-05g / T-05-07：local restricted raw-output artifact reference contract；仅合成/离线/本地 contract 与 safe projections，不得真实模型输出、真实数据、持久化写入、全文普通日志/业务对象泄露或 T-05-08+。 |
...
| 0234 | `log/0234-codex-to-cc-workorder-WP-05g.md`（OPEN，启动 WP-05g / T-05-07 local restricted raw-output artifact reference contract；轮到 CC） |
