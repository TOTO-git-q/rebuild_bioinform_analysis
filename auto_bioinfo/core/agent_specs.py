...
def build_agent_specs() -> dict[str, dict[str, Any]]:
    specs = [
        AgentSpec(
            ...
            forbidden_actions=[
                "recommend_specific_database",
                "generate_result",
                "claim_question_is_proven",
                "raise_claim_ceiling",
                "run_analysis",
                "lock_dataset",
                "call_external_database",
            ],
        ...
        AgentSpec(
            ...
            forbidden_actions=[
                "add_unrequested_disease_scope_without_reason",
                "mix_model_organism_with_human_evidence",
                "mark_mismatched_tissue_or_cell_type_as_suitable",
                "run_analysis",
                "lock_dataset",
                "make_biological_claim",
            ],
        ...
        AgentSpec(
            ...
            forbidden_actions=[
                "mark_specific_dataset_verified",
                "generate_codex_task",
                "propose_claim_level_beyond_data_support",
                "run_analysis",
                "lock_dataset",
                "invent_dataset",
                "make_biological_claim",
        ...
        AgentSpec(
            ...
            forbidden_actions=[
                "set_verified_true_without_real_metadata",
                "use_placeholder_accession",
                "treat_paper_mention_as_dataset_usability",
                "ignore_metadata_group_sample_size_organism_tissue_or_platform",
                "run_analysis",
                "make_biological_claim",
                "lock_unverified_dataset",
            ],
        ...
        AgentSpec(
            ...
            forbidden_actions=[
                "generate_biological_result",
                "select_method_unsupported_by_input_data",
                "mix_engineering_task_with_analysis_task",
                "omit_expected_inputs_outputs_qc_or_failure_conditions",
                "modify_raw_result",
                "approve_own_output",
            ],
        ...
        AgentSpec(
            ...
            forbidden_actions=[
                "modify_raw_result",
                "fabricate_missing_output",
                "ignore_warning_or_error",
                "approve_failed_qc_artifact",
                "rerun_analysis_without_task",
                "make_final_report",
            ],
        ...
        AgentSpec(
            ...
            forbidden_actions=[
                "consume_unaudited_evidence",
                "generate_unsupported_claim",
                "exceed_claim_ceiling",
                "omit_failed_results_or_limitations",
                "raise_claim_ceiling",
                "invent_evidence",
            ],
