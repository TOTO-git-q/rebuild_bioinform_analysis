"""Lane-4 failure-recovery layer (WP-25).

Pure, offline, deterministic domain logic that turns failure handling into
predictable, bounded decisions rather than ad-hoc retries or prose:
