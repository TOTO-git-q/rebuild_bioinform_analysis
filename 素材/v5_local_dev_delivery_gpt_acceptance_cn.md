...
- 工程根目录：`%USERPROFILE%/Documents/target`
- v5 默认项目：`%USERPROFILE%/Documents/target/projects/vascular_aging_demo`
- v5 自检报告：`%USERPROFILE%/Documents/target/projects/vascular_aging_demo/v5/doctor/v5_doctor_report.json`
- v5 后端激活：`%USERPROFILE%/Documents/target/projects/vascular_aging_demo/v5/active_backends.json`
- v5 报告清单：`%USERPROFILE%/Documents/target/projects/vascular_aging_demo/v5/reports/canonical_report_manifest.json`
- v5 流程页：`http://127.0.0.1:8801/v5/flow`
- v5 本地执行包：`%USERPROFILE%/Documents/target/projects/vascular_aging_demo/v5/local_execution/local_execution_bundle.json`
- v5 Artifact Registry：`%USERPROFILE%/Documents/target/projects/vascular_aging_demo/v5/artifact_registry.jsonl`
- 开发 bundle：`%USERPROFILE%/Documents/target/dist/targetcompass_v5_local_bundle_20260623T113401Z.zip`
- Windows 安装脚本包：`%USERPROFILE%/Documents/target/dist/TargetCompassV5_Windows_Installer_20260623T113501Z.zip`

## GPT/Codex 验收命令

在 `%USERPROFILE%/Documents/target` 下执行：
