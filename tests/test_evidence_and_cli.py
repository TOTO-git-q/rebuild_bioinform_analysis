...
class ClaimCeilingTest(unittest.TestCase):
    ...
    def test_synthesized_claim_respects_ceiling(self):
        claims = synthesize_claims(evidence_items=[self._evidence("association")], research_spec={}, scope_bundle={}, project_ceiling="association")
    ...
    def test_ceiling_clamps_below_method_capability(self):
        ...
        claims = synthesize_claims(evidence_items=[self._evidence("causal_support")], research_spec={}, scope_bundle={}, project_ceiling="association")
        self.assertEqual(claims[0]["claim_level"], "association")

    def test_null_result_is_represented(self):
        ev = self._evidence("association")
        ev["effect_summary"]["n_significant"] = 0
        claims = synthesize_claims(evidence_items=[ev], research_spec={}, scope_bundle={}, project_ceiling="association")
